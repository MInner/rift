# like 1_2_14 with celeba eval, attr/total and saving best
...
dataset_defaults = {
    ...
    'synaction_bg_vs_idt_v3': {
        ...
        'gt_dataset_fn': 'gt.txt',
        'gt_dataset_img_folder': 'all',
        'gt_attr_clf_model_path': '/scratch3/run/honest_disent/attr_models/synaction3_v3/',
        'is_categorical_attr': {
            'idt': True, 'bg': True,
        ...
        'final_gt_score_weights': {
            'idt': 1.0, 'bg': 1.0,
            'pose-0': 1.0/16, 'pose-1': 1.0/16, 'pose-2': 1.0/16, 'pose-3': 1.0/16, 'pose-4': 1.0/16, 'pose-5': 1.0/16, 'pose-6': 1.0/16, 'pose-7': 1.0/16, 
            'pose-8': 1.0/16, 'pose-9': 1.0/16, 'pose-10': 1.0/16, 'pose-11': 1.0/16, 'pose-12': 1.0/16, 'pose-13': 1.0/16, 'pose-14': 1.0/16, 'pose-15': 1.0/16, 
        }
    },
    'celeba_custom_split': {
        ...
        'gt_dataset_img_folder': 'all',
        'gt_attr_clf_model_path': '/scratch3/run/honest_disent/attr_models/celeba_v2/',
        'is_categorical_attr': {
        ...
        'final_gt_score_weights': {
            ...
            'ori-x': 0.3, 'ori-y': 0.3, 'ori-z': 0.3, 'bg-r': 0.3, 'bg-g': 0.3, 'bg-b': 0.3, 'skin-r': 0.3, 'skin-g': 0.3, 'skin-b': 0.3,
        }
    }
}
