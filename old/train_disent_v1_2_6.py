# like 1_2_5 but with separate style noise controll 
...
def train_G(A, B, A2B_B_s_gt, B2A_A_s_gt):
    with tf.GradientTape() as t:
        ...
        A2B2A, s_b_rand_rec = G_B2A_fn(
            with_noise(A2B, args.defence_noise_sigma), 
            with_noise(s_a, args.style_noise_sigma), training=True)
        B2A2B, s_a_rand_rec = G_A2B_fn(
            with_noise(B2A, args.defence_noise_sigma), 
            with_noise(s_b, args.style_noise_sigma), training=True)
